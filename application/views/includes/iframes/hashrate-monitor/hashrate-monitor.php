<div class="row">
    ...
    <script>
        ...
        window.onload = function () {
            ...
            ctxh.height = 100;
            $.getJSON('http://localhost/poolworks.io/Hashratemonitor/getHasRates', function (data) {
        ...
        function getWorkers(name, id) {
            ...
            var k = 'http://localhost/poolworks.io/Hashratemonitor/getWorkers';
        ...
        function addNew() {
            ...
            if (val) {
                var k = 'http://localhost/poolworks.io/Hashratemonitor/getGroup';
                $.ajax({
                    type: 'POST',
                    url: k,
                    data: {id: val},
        ...
        function saveChanges() {
            ...
            var k = 'http://localhost/poolworks.io/Hashratemonitor/saveGroupChanges';
            $.ajax({
                type: 'POST',
                url: k,
            ...
            <div id="toolbar-row">
                ...
                if ($groups) {
                    foreach ($groups as $row) {
                        ?>
                        <button class="btn btn-primary waves-effect waves-brown " onclick="getWorkers('<?php echo $row->name; ?>', '<?php echo $row->user_id; ?>')">
                            <?php echo $row->name; ?>
                        </button>
                        <?php
                    }
                ...
                if ($user->gid == 3) {
                    ?>
                    <button class="btn btn-primary waves-effect waves-brown " onclick="getWorkers('<?php echo $user->name; ?>', '<?php echo $user->user_id; ?>')">
                        <?php echo $user->name; ?>
                    </button>
                    <?php
                }
