<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $.get('<?php echo base_url(); ?>contentwidget/getAllContentWidget', function (data) {
            if (data) {
                $('#bittrex_btcusd').html(data['bittrex_btcusd']);
                $('#fullworkers_users').html(data['fullworkers']['users']);
                $('#fullworkers_workers').html(data['fullworkers']['workers']);
                $('#allhashrates_all').html(data['allhashrates']['all'] + 'PH');
                $('#allhashrates_my').html(data['allhashrates']['my'] + 'PH');
                $('#of_poo_percent').html((parseInt(data['allhashrates']['my']) * 100 / parseInt(data['allhashrates']['all'])) + '% OF POOL');
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="card-box widget-box-2 bg-white">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h5>
                        <p> USD : <span id="bittrex_btcusd"><?php //echo $bittrex_btcusd;   ?></span></p>
                    </h5>
                </div>
            </div>
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="card-box widget-box-2 bg-white">
            ...
            <div class="mini-stat-info text-right text-dark">
                <span class="counter text-dark" id="fullworkers_users"><?php //echo $fullworkers['users'];   ?></span>
                Users
            </div>

            <div class="mini-stat-info text-right text-dark">
                <span class="counter text-dark" id="fullworkers_workers"><?php //echo $fullworkers['workers'];   ?></span>
                Workers
            </div>
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="card-box widget-box-2 bg-white">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>
                        <p> POOL <span class="pull-right" id="allhashrates_all"><?php //echo $allhashrates['all']   ?> PH</span> </p>
                        <p> YOUR <span class="pull-right" id="allhashrates_my"><?php //echo $allhashrates['my']   ?> PH</span> </p>
                    </h5>
                </div>
            </div>
            <p class="text-muted" id="of_poo_percent"><?php // echo $allhashrates['my'] * 100 / $allhashrates['all'];   ?>% OF POOL</p>
        </div>
    </div>
</div>
